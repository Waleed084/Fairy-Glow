...
const MyForm = () => {
  ...
  const handleMainFormSubmit = async () => {
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_HOST}/api/postMattress`, formData);
  ...
  return (
    <Container maxWidth="sm" style={inlineStyles.container}>
      <h2 style={{ color: '#680aa3' }}>Mattress Order Details</h2>
